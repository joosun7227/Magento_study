...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Product\Link\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addLinkTypeIdFilter');
        return $pluginInfo ? $this->___callPlugins('addLinkTypeIdFilter', func_get_args(), $pluginInfo) : parent::addLinkTypeIdFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addProductIdFilter');
        return $pluginInfo ? $this->___callPlugins('addProductIdFilter', func_get_args(), $pluginInfo) : parent::addProductIdFilter();
    }
